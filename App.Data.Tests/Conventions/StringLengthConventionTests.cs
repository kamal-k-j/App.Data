...
{
    public class StringLengthConventionTests
    {
        protected const int ExpectedStringLength = 100;

        protected class DecoratedEntity
        {
            [StringLength(ExpectedStringLength)]
            public virtual string TestProperty { get; set; }

            public virtual string UndecoratedProperty { get; set; }
        ...
        [Fact]
        public void WhenDeterminingIfTheConventionShouldBeAppliedToAUndecoratedStringProperty()
        {
            // Arrange
            IPropertyConventionAcceptance subject = new StringLengthConvention();
            var acceptanceCriteriaMock = new Mock<IAcceptanceCriteria<IPropertyInspector>>();
        ...
        [Fact]
        public void WhenDeterminingIfTheConventionShouldBeAppliedToADecoratedNonStringProperty()
        {
            // Arrange
            IPropertyConventionAcceptance subject = new StringLengthConvention();
            var acceptanceCriteriaMock = new Mock<IAcceptanceCriteria<IPropertyInspector>>();
        ...
        [Fact]
        public void WhenApplyingTheConventionToADecoratedStringProperty()
        {
            // Arrange
